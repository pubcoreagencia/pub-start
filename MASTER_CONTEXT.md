# MASTER CONTEXT — PUB Start

**Identificador Canônico:** `pub-start`  
**Vertical:** Tecnologia  
...
Incubadora e framework de bootstrap de novos negócios digitais.
...
- **Repositório GitHub:** `pubcoreagencia/pub-start`
